...
# Two-pacth model - with seasonality with movement -- ONE YEAR
# In the following, we run the simulation for one year
...
# Two-pacth model - with (AND WITHOUT) seasonality with movement 
...
text(1,11.9, "A", xpd = NA, cex = 1.6)

text(6,11.9, "Endemic patch", xpd = NA, cex = 1.6, font = 1)
...
text(1,6, "B", xpd = NA, cex = 1.6)
text(6,6, "Settlement patch", xpd = NA, cex = 1.6, font = 1)
...
################################################################################
      SIMILAR TO FIGURES 3 AND 4 IN THE PAPER (MOVED TO APPENDIX)
