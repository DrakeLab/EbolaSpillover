...
title("Endemic patch (wildland)", cex.main = 1.3, font.main = 1)
...
text(6,11.9, "Endemic patch (wildland)", xpd = NA, cex = 1.1, font = 1)
...
title("Endemic patch (wildland)", cex.main = 1.1, font.main = 1)
# adding a legend:
