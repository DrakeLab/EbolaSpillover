...
with(results_season05, { # stochastic model results
  ...
  plot(time_, infected_A, col = "orangered", type = "l",
       xlab = " ", ylab = "Infected", ylim = c(0, 60), xlim=c(0,t_max),
       cex.lab = 1.2, cex.axis = 1.2, lwd = 2.5, panel.first = grid())

})

text(0,75, "A", xpd = NA, cex = 1.6)
text(50,40, expression(sigma == 0.5), xpd = NA, cex = 1.6)
...
with(results_season05, { # stochastic model results
  ...
  plot(time_, infected_B, col = "orangered", type = "l",
       xlab = " ", ylab = " ", ylim = c(0, 8), xlim=c(0,t_max),
       cex.lab = 1.2, cex.axis = 1.2, lwd = 2.5, panel.first = grid())

})

text(0,10, "B", xpd = NA, cex = 1.6)

text(50,5, expression(sigma == 0.5), xpd = NA, cex = 1.6)
...
with(results_season09, { # stochastic model results
  ...
  plot(time_, infected_A, col = "orangered", type = "l",
       xlab = "Time (years)", ylab = "Infected", ylim = c(0, 60), xlim=c(0,t_max),
       cex.lab = 1.2, cex.axis = 1.2, lwd = 2.5, panel.first = grid())

})

text(0,75, "C", xpd = NA, cex = 1.6)
text(50,40, expression(sigma == 0.9), xpd = NA, cex = 1.6)


with(results_season09, { # stochastic model results
  
  plot(time_, infected_B, col = "orangered", type = "l",
       xlab = "Time (years)", ylab = " ", ylim = c(0, 8), xlim=c(0,t_max),
       cex.lab = 1.2, cex.axis = 1.2, lwd = 2.5, panel.first = grid())

})

text(0,10, "D", xpd = NA, cex = 1.6)

text(50,5, expression(sigma == 0.9), xpd = NA, cex = 1.6)
