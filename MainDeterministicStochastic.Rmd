---
title: "Two-patch deterministic and stochastic models for Ebola spillover"
output:
...
This report contains all code for numerical implementation of the two-patch deterministic and stochastic models presented in the main text of the manuscript entitled: "Theory of infectious disease spillover at an ecological boundary: Impacts of seasonality and cross boundary movement".  
...
# Two-patch model - without seasonality without movement 

In the following, we run the simulation for one year
...
Plotting the baseline results: without seasonality without movement - one year
...
with(results, { # stochastic model results
  ...
  lines(time_, susceptible_A, type = "l", col = "black", lwd = 2)
  lines(time_, infected_A, type = "l", col = "black", lwd = 2)
  lines(time_, recovered_A, type = "l", col = "black", lwd = 2)


})

text(0,121, "A", xpd = NA, cex = 1.6)
   
title("Endemic patch (reservoir)", cex.main = 1.3, font.main = 1)
...
with(results, { # stochastic model results
  ...
  lines(time_, susceptible_B, type = "l", col = "black", lwd = 2)
  lines(time_, infected_B, type = "l", col = "black", lwd = 2)
  lines(time_, recovered_B, type = "l", col = "black", lwd = 2)

})

text(0,1230, "B", xpd = NA, cex = 1.6)

title("Episodic patch (settlement)", cex.main = 1.3, font.main = 1)
...
# Two-patch model - with seasonality with movement -- ONE YEAR

Here we run the simulation for one year.
...
# Two-patch model - without seasonality with movement 
In the following, we run the simulation for 10 years

In the stochastic model, extinction occurs as a result of fluctuations near the time axis.
This occurs when we run the simulation for long periods of time (more than one year).
To avoid extinction, we added a constant to the transmission rate in the reservoir patch. A value of 15 was added in the CTMC model before we run the simulation.

```{r, echo=FALSE}
# calling the deterministic model from outside this markdown document

source("Two_Patch_Ebola_ODE_Model.R")
two_patch_SIR_without_seasonality <- Two_Patch_Ebola_Model
...
sir_values <- ode(
  y = initial_values,
  times = time,
  func = two_patch_SIR_without_seasonality,
  parms = params
)
...
Plotting the results: without seasonality with movement -- 10 years
...
par(mfrow = c(1,2), mai = c(1.5,0.8,1.5,0.2), mgp = c(2, 0.7, 0))
...
# plotting the time series of susceptibles:
  plot(time, I_A, col = "orangered", type = "l",
       xlab = "Time (years)", ylab = "Number of infected", ylim = c(0, 10), xlim=c(1,10),
...
text(1,11.9, "A", xpd = NA, cex = 1.3)

text(6,11.9, "Endemic patch (reservoir)", xpd = NA, cex = 1.1, font = 1)
...
text(1,6, "B", xpd = NA, cex = 1.3)
text(6,6, "Episodic patch (settlement)", xpd = NA, cex = 1.1, font = 1)
...
text(0,117, "A", xpd = NA, cex = 1.3)

title("Endemic patch (reservoir)", cex.main = 1.1, font.main = 1)
# adding a legend:
...
text(0,1170, "B", xpd = NA, cex = 1.3)


title("Episodic patch (settlement)", cex.main = 1.1, font.main = 1)
...
# Trajectories vs seasonality amplitude -- 100 years

With seasonality and movement
...
# changing the value of seasonality to produce trajectoris
params$seasonality <- 0.9

sir_values_season09 <- ode(
  y = initial_values,
  times = time,
  func = two_patch_SIR_with_seasonality,
  parms = params
...
# Plotting the results: trajectories -- 100 years
...
sir_values_season09 <- as.data.frame(sir_values_season09)
#######################################################
# calling the stochastic simulation model from outside this markdown document
...
# plotting trajectories
  ...
  plot(S_A, I_A, type = "l", col = "yellow3",
       xlab = " ", ylab = "Infected", xlim = c(0, 100), ylim = c(0, 70),
       cex.lab = 1.2, cex.axis = 1.2, lwd = 2, panel.first = grid())
  box()
  
  points(S_A[length(S_A)], I_A[length(I_A)], pch = 19, cex = 1.3,
       col = "yellow4")
...
text(0,85, "A", xpd = NA, cex = 1.6)

text(80,55, expression(sigma == 0.5), xpd = NA, cex = 1.6)
...
# plotting trajectories:
  plot(S_B, I_B, type = "l", col = "yellow3",
       xlab = " ", ylab = " ", xlim = c(200, 1000), ylim = c(0, 15),
       cex.lab = 1.2, cex.axis = 1.2, lwd = 2, panel.first = grid())
  box()

    points(S_B[length(S_B)], I_B[length(I_B)], pch = 19, cex = 1.3,
       col = "yellow4")
})



text(200,18, "B", xpd = NA, cex = 1.6)

text(900,11.5, expression(sigma == 0.5), xpd = NA, cex = 1.6)
...
with(sir_values_season09, { # deterministic model results
  
# plotting trajectories

  plot(S_A, I_A, type = "l", col = "yellow3",
       xlab = "Susceptible", ylab = "Infected", xlim = c(0, 100), ylim = c(0, 70),
       cex.lab = 1.2, cex.axis = 1.2, lwd = 2, panel.first = grid())
  box()
...
text(0,88, "C", xpd = NA, cex = 1.6)

text(80,55, expression(sigma == 0.9), xpd = NA, cex = 1.6)
...
with(sir_values_season09, { # deterministic mode results
  
# plotting trajectories:
  plot(S_B, I_B, type = "l", col = "yellow3",
       xlab = "Susceptible", ylab = " ", xlim = c(200, 1000), ylim = c(0, 15),
       cex.lab = 1.2, cex.axis = 1.2, lwd = 2, panel.first = grid())
  box()
...
text(200,19, "D", xpd = NA, cex = 1.6)

text(900,11.5, expression(sigma == 0.9), xpd = NA, cex = 1.6)

```

# Stochastic results: seasonality vs periodicity -- 10 years
...
results_season05 <- CTMC_Ebola(params, t_max)


params$seasonality <- 0.9

results_season09 <- CTMC_Ebola(params, t_max)
...
with(results_season05, { # stochastic model results
  
  plot(time_, infected_A, col = "orangered", type = "l",
       xlab = " ", ylab = "Number of infected", ylim = c(0, 30), xlim=c(0,t_max),
       cex.lab = 1.2, cex.axis = 1.2, lwd = 2.5, panel.first = grid())

})

text(0,37, "A", xpd = NA, cex = 1.6)
text(50,22, expression(sigma == 0.5), xpd = NA, cex = 1.6)
...
with(results_season05, { # stochastic model results
  ...
  plot(time_, infected_B, col = "orangered", type = "l",
       xlab = " ", ylab = " ", ylim = c(0, 10), xlim=c(0,t_max),
       cex.lab = 1.2, cex.axis = 1.2, lwd = 2.5, panel.first = grid())

})

text(0,12.5, "B", xpd = NA, cex = 1.6)

text(50,8, expression(sigma == 0.5), xpd = NA, cex = 1.6)
...
with(results_season09, { # stochastic model results
  
  plot(time_, infected_A, col = "orangered", type = "l",
       xlab = "Time (years)", ylab = "Number of infected", ylim = c(0, 30), xlim=c(0,t_max),
       cex.lab = 1.2, cex.axis = 1.2, lwd = 2.5, panel.first = grid())

})

text(0,37, "C", xpd = NA, cex = 1.6)
text(50,22, expression(sigma == 0.9), xpd = NA, cex = 1.6)


with(results_season09, { # stochastic model results
  
  plot(time_, infected_B, col = "orangered", type = "l",
       xlab = "Time (years)", ylab = " ", ylim = c(0, 10), xlim=c(0,t_max),
       cex.lab = 1.2, cex.axis = 1.2, lwd = 2.5, panel.first = grid())

})

text(0,12.5, "D", xpd = NA, cex = 1.6)

text(50,8, expression(sigma == 0.9), xpd = NA, cex = 1.6)



```

# Trajectories vs dispersal magnitude -- 100 years
...
# changing the value of seasonality to produce trajectoris
params$phi_BA_base <- 0.1

sir_values_dispersal01 <- ode(
  y = initial_values,
  times = time,
  func = two_patch_SIR_with_seasonality,
  parms = params
...
sir_values_dispersal01 <- as.data.frame(sir_values_dispersal01)
#######################################################
# calling the stochastic simulation model from outside this markdown document
...
text(80,55, expression(phi[BA] == 0.04), xpd = NA, cex = 1.6)
...
# plotting trajectories:
  plot(S_B, I_B, type = "l", col = "yellow3",
       xlab = " ", ylab = " ", xlim = c(100, 1000), ylim = c(0, 15),
       cex.lab = 1.2, cex.axis = 1.2, lwd = 2, panel.first = grid())
  box()
...
text(100,18, "B", xpd = NA, cex = 1.6)

text(800,11.5, expression(phi[BA] == 0.04), xpd = NA, cex = 1.6)
...
with(sir_values_dispersal01, { # deterministic model results
...
text(80,55, expression(phi[BA] == 0.1), xpd = NA, cex = 1.6)
...
with(sir_values_dispersal01, { # deterministic mode results
  
# plotting trajectories:
  plot(S_B, I_B, type = "l", col = "yellow3",
       xlab = "Susceptible", ylab = " ", xlim = c(100, 1000), ylim = c(0, 18),
       cex.lab = 1.2, cex.axis = 1.2, lwd = 2, panel.first = grid())
  box()
...
text(100,23, "D", xpd = NA, cex = 1.6)

text(800,11.5, expression(phi[BA] == 0.1), xpd = NA, cex = 1.6)
...
# Effect of seasonality amplitude on the epidemic peak  
...
# Plot seasonality amplitude -- one year


```{r fig6, echo=FALSE, fig.width = 9, fig.height = 3}
...
# adding a legend:
legend("right", c("Reservoir patch", "Settlement patch"),
...
The epidemic peak as a function of model parameters: seasonality and dispersal
In the following, we will run the simulation for one year
...
legend(0.3, 37, c("Reservoir patch", "Settlement patch"),
